"""
极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极极
║  TTS DIAGNOSTICS — debug_tts.py                                         ║
║                                                                          ║
║  What this file does:                                                    ║
║  ─────────────────────────────────────────────────────────────────────  ║
║  A standalone Streamlit tool to verify every step of the audio pipeline  ║
║  outside of the main RAG application. Use this if the oracle is silent.  ║
║                                                                          ║
║  Checks performed:                                                       ║
║    1. Library imports (elevenlabs, pydub, numpy)                         ║
║    2. System dependencies (ffmpeg)                                       ║
║    3. API Connectivity (ElevenLabs convert)                              ║
║    4. Audio Processing (pydub decode, normalize, compress)               ║
║    5. Music Synthesis & Mixing (numpy oscillators + pydub overlay)        ║
║                                                                          ║
║  Usage:                                                                  ║
║    streamlit run debug_tts.py                                            ║
╚══════════════════════════════════════════════════════════════════════════╝
"""
...
from core.config import ELEVENLABS_API_KEY, TTS_VOICE_ID, TTS_MODEL
...
TTS_VOICE_ID = st.text_input("Voice ID", value=TTS_VOICE_ID)
TTS_MODEL    = st.text_input("Model ID", value=TTS_MODEL)
