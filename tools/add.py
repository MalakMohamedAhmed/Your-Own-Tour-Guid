"""
╔══════════════════════════════════════════════════════════════════════════╗
║  MODEL CONVERTER — add.py                                               ║
║                                                                          ║
║  What this file does:                                                    ║
║  ─────────────────────────────────────────────────────────────────────  ║
║  Converts raw PyTorch/Pickle model checkpoints (e.g., data.pkl) into    ║
║   the standard model.pth format used by the Kemet RAG classifier.       ║
║                                                                          ║
║  Key features:                                                           ║
║    • Automatic unwrapping of common state_dict wrappers (model, net, etc)║
║    • Fallback to raw pickle if torch.load fails                         ║
║    • Internal verification: attempts a sample load back into Swin-T     ║
║                                                                          ║
║  Usage:                                                                  ║
║    python add.py                                                         ║
╚══════════════════════════════════════════════════════════════════════════╝
